...
<?php
if (!empty($_GET['id'])) { // Jika ada parameter id, tampilkan halaman detail produk
    extract($_GET);
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-12 content-menu" style="margin-top:-20px;">
                    ...
                    <p>
                        <a href="<?php echo $url; ?>menu.php" class="btn btn-success" role="button">Kembali</a>
                        <a href="<?php echo $url; ?>keranjang.php?act=beli&produk_id=<?php echo $data['id'] ?>" class="btn btn-info" role="button">Pesan</a>
                    </p>
                </div>
            </div>
        </div>
...
<?php } elseif (!empty($_GET['kategori'])) { // Jika ada parameter kategori, tampilkan produk berdasarkan kategori
    extract($_GET);
...
<?php } else { // Jika tidak ada parameter, tampilkan semua produk ?>
    <div class="col-md-9">
        <div class="row">
            <div class="col-md-12">
                <hr>
                <h3>Daftar Produk Kacamata</h3>
                <?php
