...
Can require as many as want, regardless of which fonts are installed.
...
To aid backwards compatability some are required:
*/
...
// Always require "sans-serif", "serif" and "monospace" etc.
